...
class Roedor {
	...
	//La clase roedor es un breve ejemplo de una mascota, maulla y además tiene diversos parámetros:
	...
	void vac() throws IOException {
		...
		System.out.println("¿El animal está vacunado contra la rabia? (y/n): \n");
		String texto;
		texto = br.readLine();
		if (texto.charAt(0) == 'y') {
			vacuna = true;
